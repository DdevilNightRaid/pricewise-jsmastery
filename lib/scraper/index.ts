...
export async function scrapeAmazonProduct(url: string) {
    ...
    //curl --proxy brd.superproxy.io:22225 --proxy-user brd-customer-hl_3420f424-zone-unblocker:osssl8zdikgz -k https://lumtest.com/myip.json

    // Brigh Data Proxy Configuration
